...
// Shippo free tier: rolling 30-day cycles anchored to the account start date.
// Confirmed by Shippo support — do not change BILLING_EPOCH unless account resets.
...
router.get('/usage', async (_req, res) => {
  ...
  // Compute current cycle start: how many complete 30-day cycles since epoch?
  const now        = new Date();
